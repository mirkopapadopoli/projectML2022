...
```{r}
allset= split.data(card.trans_data, s = 300)
...
#zk = 1
#while(zk <= 20){
#  reducedset = split.data(trainset, s = zk)
#  redtrainset = reducedset$train
#  validationset = reducedset$test
#  zk = zk+1
#}
```
